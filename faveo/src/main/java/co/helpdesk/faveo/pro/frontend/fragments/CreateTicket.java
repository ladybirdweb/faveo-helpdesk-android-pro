...
public class CreateTicket extends Fragment {
    ...
    private void setUpViews(View rootView) {
        ...
        ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, Preference.getValueTopic().split(",")); //selected item will look like a spinner set from XML
        ...
        spinnerArrayAdapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, Preference.getValueSLA().split(",")); //selected item will look like a spinner set from XML
        spinnerArrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
